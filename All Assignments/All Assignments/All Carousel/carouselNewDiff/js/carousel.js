    ...
    $(window).ready(function () {
        ...
        function buttonClickEvent() {
            $cnbtn.click(function () {
                ...
                if (numFrames < 1 || numFrames > 5) {
                    alert("Please Enter proper value of Frame number between 1-5");
                    return;

                }

                imageWidth = (parseInt($img.css("width"), 10)) + 20;
                sliderWidth = (parseInt($slider.css("width"), 10)) + ((numFrames - 2) * imageWidth);
                ...
                $divCarousel.css("width", sliderWidth + 200);
